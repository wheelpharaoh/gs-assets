function new(id)
    ...
    local instance = {
        ...
        setTalkTable = function (this)
            this.chats[1].chat = {
                {character = "Grad",talk = "ロイ…てめぇだけは俺が潰す！"},
                {character = "Roy",talk = "やれるものならやってみるがいい"},
                {character = "Grad",talk = "ああ…やってやる…やってやるよ！"}
            };

            this.chats[2].chat = {
                {character = "Grad",talk = "今日こそ決着つけようぜ"},
                {character = "Roy",talk = "悪いが貴様に負ける気はしない"},
                {character = "Grad",talk = "チッ…その態度が…"},
                {character = "Grad",talk = "気に食わねえんだよ！"}
            };

            this.chats[3].chat = {
                {character = "Grad",talk = "さぁ…楽しませてくれよ！"},
                {character = "Roy",talk = "貴様の相手をしている暇はない"},
                {character = "Grad",talk = "ケッ！粋がるのは今のうちだぞ！"}
            };
        end,
