function new(id)
    ...
    local instance = {
        ...
        rageTimer = 0,
        rageSPUpValue = 20,
        messages = summoner.Text:fetchByEnemyID(500133915),
        ...
        addBuff = function(this,unit)
            ...
            unit:getTeamUnitCondition():addCondition(-14,60,-this.consts.barnDown,2000,0);
        ...
        update = function (this , unit , deltatime)
            ...
            if this.isRage then
                ...
                if condValue ~= 0 then
                    unit:setBreakPoint(unit:getBreakPoint() - condValue * deltatime * 2);
                end
