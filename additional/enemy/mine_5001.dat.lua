...
local class = summoner.Bootstrap.createEnemyClass({label="神焔竜デグルマグナ", version=1.3, id="mine_50001"});
...
function class:start(event)
    ...
    self.START_MESSAGES = {
        {
            MESSAGE = self.TEXT.START_MESSAGE1 or "クリティカル率アップ",
            COLOR = Color.red,
            DURATION = 5
        },
        {
            MESSAGE = self.TEXT.START_MESSAGE2 or "クリティカルダメージアップ",
            COLOR = Color.red,
            DURATION = 5
        }
    }
