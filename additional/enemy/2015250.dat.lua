...
local class = summoner.Bootstrap.createEnemyClass({label="サク", version=1.3, id=2015250});
...
function class:setMessageBoxList()
   ...
   self.HP80_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP80_MESSAGE1 or "水属性に対するダメージアップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false
      }
   ...
   self.HP60_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP50_MESSAGE1 or "味方全体の水属性耐性・氷結耐性アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false
      }     
