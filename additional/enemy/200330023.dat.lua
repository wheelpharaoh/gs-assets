function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(200330022),
        ...
        run = function (this , unit , str)
            ...
            if str == "summon1" then return this.summon1(this,unit) end
            if str == "summon2" then return this.summon2(this,unit) end
            if str == "summon3" then return this.summon3(this,unit) end
            if str == "addBat" then return this.addBat(this,unit) end
            return 1;
        end,
        ...
        startWave = function (this , unit , waveNum)
            ...
            this.utill.showMessage(this.messages.mess5,this.colors.blue,5,39);
            this.utill.showMessage(this.messages.mess4,this.colors.green,5,40);
            this.utill.showMessage(this.messages.mess6,this.colors.yellow,5,41);
        ...
        update = function (this , unit , deltatime)
            ...
            if this.infoFlg then
                this.infoTimer = this.infoTimer + deltatime;

                if this.infoTimer > 5 then
                    this.infoFlg = false;
