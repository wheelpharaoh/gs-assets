function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(2005433),
        ...
        glabControll = function(this,unit,deltatime)
            ...
            if this.glabTarget ~= nil then
                if this.glabTarget:getTeamUnitCondition():findConditionWithID(500151) == nil then
                    this.glabTarget:getTeamUnitCondition():addCondition(500151,114,333,15);
                end
            end
        ...
        rageEnd = function(this,unit)
            ...
            BattleControl:get():pushEnemyInfomation(this.messages.mess2,mess1Color.r,mess1Color.g,mess1Color.b,messageDuration);
        ...
        startWave = function (this , unit , waveNum)
            ...
            BattleControl:get():pushEnemyInfomation(this.messages.mess3,mess1Color.r,mess1Color.g,mess1Color.b,5);
            return 1;
        end,
