...
function new(id)
    ...
    local instance = {
        ...
        takeBreake = function (this,unit)
            BattleControl:get():pushEnemyInfomation(summoner.Text:fetchByEnemyID(2014837).mess3,255,0,0,10);
        ...
        startWave = function (this , unit , waveNum)
            BattleControl:get():pushEnemyInfomation(summoner.Text:fetchByEnemyID(2014837).mess2,255,0,0,10);
