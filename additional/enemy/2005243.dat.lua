local class = summoner.Bootstrap.createEnemyClass({label="リアナ", version=1.3, id=2005243});
...
function class:start(event)
    ...
    self.HPFlags = {
        [80] = {time = 10,isActive = true},
        [60] = {time = 20,isActive = true},
        [40] = {time = 30,isActive = true},
        [20] = {time = 40,isActive = true}
    }
