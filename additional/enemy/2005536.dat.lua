...
local class = summoner.Bootstrap.createEnemyClass({label="501311413", version=1.3, id=2005536});
...
function class:start(event)
    ...
    self.START_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.START_MESSAGE or "暗闇時以外ダメージ無効",
            COLOR = Color.yellow,
            DURATION = 10
        },
        [1] = {
    ...
    self.BUFF_MESSAGES1 = {
        [0] = {
            MESSAGE = self.TEXT.BUFF_MESSAGE1 or "クリティカル率アップ",
            COLOR = Color.yellow,
            DURATION = 10
        }
    }
    ...
    self.BUFF_MESSAGES2 = {
        [0] = {
            MESSAGE = self.TEXT.BUFF_MESSAGE2 or "クリティカルダメージアップ",
            COLOR = Color.yellow,
            DURATION = 10
        }
    }
    ...
    self.BUFF_MESSAGES3 = {
        [0] = {
            MESSAGE = self.TEXT.BUFF_MESSAGE3 or "奥義ゲージ速度アップ",
            COLOR = Color.yellow,
            DURATION = 10
        },
        [1] = {
            MESSAGE = self.TEXT.BUFF_MESSAGE3_2 or "クリティカル率アップ",
            COLOR = Color.yellow,
            DURATION = 10
        },
        [2] = {
            MESSAGE = self.TEXT.BUFF_MESSAGE3_3 or "クリティカルダメージアップ",
            COLOR = Color.yellow,
            DURATION = 10
        }
    }
...
function class:setUpCrystalBuffs(event)
    ...
    self.crystalBuffs[3] = {action = function(luaInstance,unit)
        ...
        luaInstance.spValue = luaInstance.spValue * 2;
...
function class:takeDamageValue(event)
    if event.unit.m_breaktime <= 0 then
            ...
            --耐性チェック
            local damage = event.value * 0.005;
