...
function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(200210080),
        talk = {
            {text = summoner.Text:fetchByEnemyID(200210080).talk1,color = {r = 220,g = 255,b = 0},isPlayer = true},
            {text = summoner.Text:fetchByEnemyID(200210080).talk2,color = {r = 50,g = 255,b = 0},isPlayer = false},
            {text = summoner.Text:fetchByEnemyID(200210080).talk3,color = {r = 220,g = 255,b = 0},isPlayer = true}
        },
