function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(2012430),
        ...
        glabControll = function(this,unit,deltatime)
            ...
            if this.glabTarget ~= nil then
                if this.glabTarget:getTeamUnitCondition():findConditionWithID(500151) == nil then
                    this.glabTarget:getTeamUnitCondition():addCondition(500151,114,133,15);
                    this.glabTarget:getTeamUnitCondition():addCondition(500152,10,-20,15);
                end
            end
        ...
        startWave = function (this , unit , waveNum)
            ...
            BattleControl:get():pushEnemyInfomation(this.messages.mess4,mess4Color.r,mess4Color.g,mess4Color.b,messageDuration);
