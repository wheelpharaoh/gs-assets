...
local class = summoner.Bootstrap.createEnemyClass({label="", version=1.3, id=2007643});
...
function class:receive5(args)
    self:excuteSickEndAction(self.gameUnit);
    return 1;
end
