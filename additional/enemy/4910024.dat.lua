...
function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(4910024),
        ...
        initialize = function (this,unit)
            ...
            this.spValue = 20;
       --      if this.messages == nil then
       --      	--データがなかった時のためのものなので直で日本語
       --      	this.messages = {
			    --     RAGE = "怒り状態",
       ...
       --      end
        ...
        summon = function (this,unit)
            ...
            -- local gameUnit = unit:getTeam():addUnit(this.summonedNumber,this.consts.SUMMON_ENEMY_ID);--指定したインデックスの位置に指定したエネミーIDのユニットを出す
            -- this.summonedNumber = this.summonedNumber + 1;
            -- if gameUnit ~= nil then
            --     gameUnit:setBurstPoint(100);--このメソッド経由で呼ばれたガウルは即座にスキルを発動できるようになる。
            -- end
            return 1;
        end,
        ...
        startWave = function (this , unit , waveNum)
            ...
            this.utill.showMessage(this.messages.BURNDOWN,this.colors.red,5);
            return 1;
        end,
