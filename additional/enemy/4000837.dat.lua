function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(4000837),
        ...
        getRage = function(this,unit)
            unit:getTeamUnitCondition():addCondition(-11,28,20,2000,7,50009);
            unit:getTeamUnitCondition():addCondition(-50077,17,20,2000,26);
