...
local class = summoner.Bootstrap.createEnemyClass({label="", version=1.3, id=2000679});
...
function class:setMessageBoxList()
  ...
  self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "魔法ダメージ無効",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false
      },
   ...
   self.DEAD_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.DEAD_MESSAGE1 or "水の加護：最大HPアップ",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false
      }
