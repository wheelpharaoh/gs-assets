...
local class = summoner.Bootstrap.createUnitClass({label="魔獣", version=1.3, id=2015037})
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "防御力アップ・クリティカル耐性アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP50_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP50_MESSAGE1 or "行動速度アップ・攻撃力アップ・奥義ゲージ速度２倍",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
