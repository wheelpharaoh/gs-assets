...
local class = summoner.Bootstrap.createEnemyClass({label="フィーナ", version=1.3, id=2005534});
...
function class:setMessageBoxList()
  self.START_MESSAGE_LIST = {
    [0] = {
      MESSAGE = self.TEXT.START_MESSAGE1 or "貴方の実力、みさせてもらいます！",
      COLOR = Color.yellow,
      DURATION = 5
    },
    [1] = {
      MESSAGE = self.TEXT.START_MESSAGE2 or "暗闇時以外ブレイク耐性UP",
      COLOR = Color.yellow,
      DURATION = 5
    },
    [2] = {
  ...
  self.FINISH_MESSAGE_LIST = {
    [0] = {
      MESSAGE = self.TEXT.FINISH_MESSAGE1 or "本気でいかせてもらいます！！",
      COLOR = Color.yellow,
      DURATION = 5
    }
  }
