...
local class = summoner.Bootstrap.createEnemyClass({label="コルセア", version=1.3, id=2004336});
...
function class:setMessageBoxList()
  self.START_MESSAGE_LIST = {
    [0] = {
      MESSAGE = self.TEXT.START_MESSAGE1 or "貴方の実力、みせてください！",
      COLOR = Color.cyan,
      DURATION = 5
    },
    [1] = {
      MESSAGE = self.TEXT.START_MESSAGE2 or "燃焼時以外ブレイク耐性UP",
      COLOR = Color.yellow,
      DURATION = 5
    }
  }
  self.FINISH_MESSAGE_LIST = {
    [0] = {
      MESSAGE = self.TEXT.FINISH_MESSAGE1 or "本気でいきます！！",
      COLOR = Color.cyan,
      DURATION = 5
    }
  }
