...
local class = summoner.Bootstrap.createEnemyClass({label="剣ベリ", version=1.3, id=2014852});
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "剣士ベリック、参る！",
         COLOR = Color.red,
         DURATION = 5,
         isPlayer = false        
      },
      [2] = {
         MESSAGE = self.TEXT.START_MESSAGE2 or "物理ダメージ無効",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
