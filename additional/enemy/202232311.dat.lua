function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByUnitID(500872413),
        ...
        attackBranch = function (this,unit)
            if this.attack4timer <= 0 then
                unit:takeAttack(4);
                this.attack4timer = this.consts.attack4Span;
                this.utill.sendEvent(this,1,4);
                return 0;
            end
        ...
        skillBranch = function (this,unit)
            ...
            --HP半分からは真奥義しか撃たない
            if this.utill.getHPParcent(unit) <= 50 then
                skillTable = {key = 3,value = 0};
            end
        ...
        update = function (this , unit , deltatime)
            this.attack4timer = this.attack4timer - deltatime;
            return 1;
        end,
