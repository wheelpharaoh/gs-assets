...
local class = summoner.Bootstrap.createEnemyClass({label="マールゼクス", version=1.3, id=0});
...
function class:start(event)
    ...
    self.HP60_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE1 or "水属性ダメージアップ",
            COLOR = Color.cyan,
            DURATION = 5
        }
    }
    ...
    self.HP40_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE1 or "炎属性ダメージアップ",
            COLOR = Color.red,
            DURATION = 5
        }
    }
    ...
    self.SWORD_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE1 or "クリティカル率アップ",
            COLOR = Color.red,
            DURATION = 5
        }
    }
    ...
    self.LANCE_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE1 or "無効化解除",
            COLOR = Color.cyan,
            DURATION = 5
        }
    }
    ...
    self.ARC_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE1 or "回避率アップ",
            COLOR = Color.green,
            DURATION = 5
        },
        [1] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE2 or "状態異常攻撃",
            COLOR = Color.green,
            DURATION = 5
        }
    }
