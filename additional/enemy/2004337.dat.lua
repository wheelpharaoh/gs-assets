...
local class = summoner.Bootstrap.createEnemyClass({label="氷怪鳥", version=1.3, id="2004337"})
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      ...
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE2 or "燃焼時、ブレイク耐性・回避率ダウン",
         COLOR = Color.yellow,
         DURATION = 10
      },
      [2] = {
