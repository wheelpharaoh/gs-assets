function new(id)
    ...
    local instance = {
        ...
        Class = 
        {
            ...
            messages = summoner.Text:fetchByEnemyID(2000674),
            ...
            Update = function(this,unit,deltatime)
                ...
                if hpparcent <= 50 and not this.Class.isRage then
                    this.Class.isRage = true;
                    BattleControl:get():pushEnemyInfomation(this.Class.messages.messageRage,summoner.Color.red.r,summoner.Color.red.g,summoner.Color.red.b,10);
                end

                if this.Class.isRage then
                    unit:setReduceHitStop(2,1);--ヒットストップ無効Lv2（メリア以外のヒットストップを受けない）　減衰量１００％
                else
                    unit:setReduceHitStop(2,0.7);--ヒットストップ無効Lv2（メリア以外のヒットストップを受けない）　減衰量70％
                end

                if hpparcent <= 25 and not this.Class.isRage2 then
                    this.Class.isRage2 = true;
                    unit:getTeamUnitCondition():addCondition(-13, 97, 1, 20000, 0);

                    BattleControl:get():pushEnemyInfomation(this.Class.messages.messageHeat3,summoner.Color.red.r,summoner.Color.red.g,summoner.Color.red.b,10);
                end
            ...
            takeAttackBranch = function(this,unit,index)
                if this.Class.forceAttackIndex ~= 0 then
                    unit:takeAttack(this.Class.forceAttackIndex);
                    this.Class.forceAttackIndex = 0;
                    return 0;
                end
            ...
            drawingAuraEffect = function (this,unit,isDrawing)
                ...
                if isDrawing == true then
                    if this.Class.WindAura == nil then
                        ...
                        BattleControl:get():pushEnemyInfomation(this.Class.messages.messageWind1,this.Class.windMessagesRGB.r,this.Class.windMessagesRGB.g,this.Class.windMessagesRGB.b,10);
                        BattleControl:get():pushEnemyInfomation(this.Class.messages.messageWind2,this.Class.windMessagesRGB.r,this.Class.windMessagesRGB.g,this.Class.windMessagesRGB.b,10);
                        unit:getTeamUnitCondition():addCondition(-12, 27, -50, 20000, 9);
                    ...
                    if this.Class.WindAura ~= nil then
                        ...
                        BattleControl:get():pushEnemyInfomation(this.Class.messages.messageWindEnd,255,0,0,10);
            ...
            updateAttackCoolTimers = function (this,unit,deltatime)
                ...
                this.Class.attack4Timer = this.Class.attack4Timer + deltatime;
                if this.Class.attack4Timer > 20 then
                    this.Class.forceAttackIndex = 4;
                    this.Class.attack4Timer = 0;
                end
                return 1;
            end,
        ...
        startWave = function (this , unit , waveNum)
            BattleControl:get():pushEnemyInfomation(this.Class.messages.messageStart1,summoner.Color.red.r,summoner.Color.red.g,summoner.Color.red.b,10);
            BattleControl:get():pushEnemyInfomation(this.Class.messages.messageStart2,summoner.Color.red.r,summoner.Color.red.g,summoner.Color.red.b,10);
            BattleControl:get():pushEnemyInfomation(this.Class.messages.messageStart3,summoner.Color.red.r,summoner.Color.red.g,summoner.Color.red.b,10);
            return 1;
        end,
