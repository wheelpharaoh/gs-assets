function new(id)
    ...
    local instance = {
        ...
        epS4 = 60,
        epS5 = 80,
        messages = summoner.Text:fetchByEnemyID(2000569),
        messageAtk = summoner.Text:fetchByEnemyID(2000569).mess1,
        messageDef = summoner.Text:fetchByEnemyID(2000569).mess2,
        messageBreak = summoner.Text:fetchByEnemyID(2000569).mess3,
        messageLastAttack = summoner.Text:fetchByEnemyID(2000569).mess4,
