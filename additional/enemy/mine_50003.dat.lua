...
local class = summoner.Bootstrap.createEnemyClass({label="怪鳥", version=1.3, id="mine_50003"})
...
function class:start(event)
   ...
   self.hitStop = math.floor((megast.Battle:getInstance():getCurrentMineFloor() - 1) / 5) * 0.2 
   self.isFlying = true
