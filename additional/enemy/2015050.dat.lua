...
local class = summoner.Bootstrap.createEnemyClass({label="ギンゾウ", version=1.3, id=2015050});
...
function class:setMessageBoxList()
   self.HP60_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP60_MESSAGE1 or "防御無視",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
...
function class:setAura(unit)
   ...
   self.aura = unit:addOrbitSystemWithFile("Kaigan6","Kaigan_in");
   self.aura:takeAnimation(0,"Kaigan_in",true);
