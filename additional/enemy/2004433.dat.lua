...
local class = summoner.Bootstrap.createEnemyClass({label="アルス", version=1.3, id=2004433});
...
function class:setMessageBoxList()
  self.START_MESSAGE_LIST = {
    [0] = {
      MESSAGE = self.TEXT.START_MESSAGE1 or "キミの実力、みせてもらうよ！",
      COLOR = Color.green,
      DURATION = 5
    },
    [1] = {
      MESSAGE = self.TEXT.START_MESSAGE2 or "氷結時以外ブレイク耐性UP",
      COLOR = Color.yellow,
      DURATION = 5
    },
    [2] = {
  ...
  self.FINISH_MESSAGE_LIST = {
    [0] = {
      MESSAGE = self.TEXT.FINISH_MESSAGE1 or "本気でいくよ！！",
      COLOR = Color.green,
      DURATION = 5
    }
  }
