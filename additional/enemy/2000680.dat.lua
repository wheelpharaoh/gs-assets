...
local class = summoner.Bootstrap.createEnemyClass({label="", version=1.3, id=2000680});
...
function class:setMessageBoxList()
  ...
  self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "魔族からのダメージ無効",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false
      },
   ...
   self.DEAD_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.DEAD_MESSAGE1 or "樹の加護：最大HPアップ",
         COLOR = Color.green,
         DURATION = 5,
         isPlayer = false
      }
