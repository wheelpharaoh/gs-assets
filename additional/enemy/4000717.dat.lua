--@additionalEnemy,4000713,4000716
local Bootstrap, Color, Random, Utility = summoner.import("Bootstrap", "Color", "Random", "Utility")
local class = summoner.Bootstrap.createEnemyClass({label="UnitName", version=1.7, id=4000717});
...
-- wave1 ガウル
class.SUMMON_GAURU_01 = 4000713
-- wave2 ガウル
class.SUMMON_GAURU_02 = 4000716
-- コロック
class.SUMMON_02 = 4000714
-- ガウルの沸きスパン(秒)
