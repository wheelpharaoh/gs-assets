function new(id)
    ...
    local instance = {
        ...
        epS4 = 40,
        epS5 = 80,
        messages = summoner.Text:fetchByEnemyID(500721955),
        messageAtk = summoner.Text:fetchByEnemyID(500721955).mess1,
        messageDef = summoner.Text:fetchByEnemyID(500721955).mess2,
        messageBreak = summoner.Text:fetchByEnemyID(500721955).mess3,
        messageLastAttack = summoner.Text:fetchByEnemyID(500721955).mess4,
