...
function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(50123),
        ...
        consts = {
            ...
            rageCoolTurnLast = 4, --怒りが収まってから次の怒り状態に移行するまでの必要行動数[後半]
        ...
        startWave = function (this , unit , waveNum)
            local cond1 = unit:getTeamUnitCondition():addCondition(-12,21,-2000,2000,24); --物理ダメージカット
            cond1:setScriptID(2);
            local cond2 =unit:getTeamUnitCondition():addCondition(-13,27,30,2000,31); --魔法ダメージのブレイク値増加
            cond2:setScriptID(3);

            BattleControl:get():pushEnemyInfomationWithConditionIcon(this.messages.mess1,24,255,255,0,8);
            BattleControl:get():pushEnemyInfomationWithConditionIcon(this.messages.mess3,24,255,255,0,8);
        ...
        takeDamageValue = function (this , unit , enemy , value)
            local critical = enemy:getTeamUnitCondition():getDamageAffectInfo().critical;
	        if critical then
                return 0;
	        end
        ...
        start = function (this , unit)
            ...
            --local maxBreakPoint = unit:getBaseBreakCapacity();
            --local healBreakPoint = maxBreakPoint / 3;
            --unit:setBreakPoint(unit:getBreakPoint() + healBreakPoint);
        ...
        excuteAction = function (this , unit)
            ...
            if hpparcent < this.consts.rageHP and not this.isRage and this.rageCoolTurnCount > rageturn and unit.m_breaktime <= 0 then
                ...
                BattleControl:get():pushEnemyInfomationWithConditionIcon(this.messages.mess1,24,255,255,0,8);
                BattleControl:get():pushEnemyInfomationWithConditionIcon(this.messages.mess3,31,255,255,0,8);
                --BattleControl:get():pushEnemyInfomation("ブレイクゲージ回復",0,255,0,8);
