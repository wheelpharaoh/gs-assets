...
local class = summoner.Bootstrap.createEnemyClass({label="ロゼッタ", version=1.3, id=2014851});
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "じゃあ、次は私だね！",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false        
      },
      [2] = {
         MESSAGE = self.TEXT.START_MESSAGE2 or "魔法ダメージ無効",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
