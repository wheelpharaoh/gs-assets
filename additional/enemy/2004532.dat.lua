function new(id)
    ...
    local instance = {
        ...
        scriptID = id,
        MESSAGES = summoner.Text:fetchByEnemyID(2004532),
        ...
        fire = function (this,unit)
            ...
            shot:setEndAnimationName("explosion2")
        ...
        receive1 = function (this , intparam)
            this:useItem(this.myself,intparam);
            return 1;
        end,
        ...
        takeBreake = function (this,unit)
            if this.isRage then
                ...
                if not(buff == nil) then
                    local conditon1 = unit:getTeamUnitCondition():findConditionWithID(-12);
                    unit:getTeamUnitCondition():removeCondition(conditon1);
                    local conditon2 = unit:getTeamUnitCondition():findConditionWithID(-13);
                    unit:getTeamUnitCondition():removeCondition(conditon2);
                    local conditon3 = unit:getTeamUnitCondition():findConditionWithID(-14);
                    unit:getTeamUnitCondition():removeCondition(conditon3);
                    local conditon4 = unit:getTeamUnitCondition():findConditionWithID(-15);
                    unit:getTeamUnitCondition():removeCondition(conditon4);
                end
            end
            return 1;
        end,
        ...
        startWave = function (this , unit , waveNum)
            ...
            summoner.Utility.messageByEnemy(this.MESSAGES.mess1,5,summoner.Color.magenta);
            return 1;
        end,
        ...
        takeAttack = function (this , unit , index)
            ...
            if ishost then
                ...
                if hpparcent < this.consts.rageHP and not this.isRage and this.rageCoolTurnCount > this.consts.rageCoolTurn and this.attackChecker == false and unit:getBreakPoint() > 0 then
            ...
            elseif index == 5 then
                ...
                unit:getTeamUnitCondition():addCondition(-12,17,20,2000,3);
                unit:getTeamUnitCondition():addCondition(-13,17,1,2000,3);
                unit:getTeamUnitCondition():addCondition(-14,17,1,2000,3);
                unit:getTeamUnitCondition():addCondition(-15,28,20,2000,0);
