function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(2000631),
        ...
        setTalkTable = function (this)
            this.chats[1].chat = {
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk1},
                {character = "Roy",talk = summoner.Text:fetchByEnemyID(2000631).talk2},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk3}
            };

            this.chats[2].chat = {
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk4},
                {character = "Roy",talk = summoner.Text:fetchByEnemyID(2000631).talk5},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk6},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk7}
            };

            this.chats[3].chat = {
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk8},
                {character = "Roy",talk = summoner.Text:fetchByEnemyID(2000631).talk9},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(2000631).talk10}
            };
        end,
