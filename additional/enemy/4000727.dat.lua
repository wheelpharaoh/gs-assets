--@additionalEnemy,4000723,4000726
local Bootstrap, Color, Random, Utility = summoner.import("Bootstrap", "Color", "Random", "Utility")
local class = summoner.Bootstrap.createEnemyClass({label="UnitName", version=1.7, id=4000727});
...
-- wave1 ガウル
class.SUMMON_GAURU_01 = 4000723
-- wave2 ガウル
class.SUMMON_GAURU_02 = 4000726
-- コロック
class.SUMMON_02 = 4000724
-- ガウルの沸きスパン(秒)
