local child = summoner.Bootstrap.createEnemyClass({label="メリア", version=1.3, id=200380033});
...
child.FIRST_BARRIER_HP = 50/100;
child.SECOND_BARRIER_HP = -1;--EX1ではバリア2回目は使用しないよう変更になりました
