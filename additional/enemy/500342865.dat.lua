function new(id)
    ...
    local instance = {
        ...
        skillCT         = 7,
        buff            = false,
        messages = summoner.Text:fetchByEnemyID(500342865),
        ...
        excuteAction = function (this , unit)  
           ...
           if this.buff == false and unit:getHPPercent() < 0.5 then
                this.buff = true;
                BattleControl:get():pushEnemyInfomationWithConditionIcon(this.messages.mess1,7,220,220,0,7);
                BattleControl:get():pushEnemyInfomationWithConditionIcon(this.messages.mess2,36,220,220,0,7);
        ...
        chargeskill = function (this , unit)
            ...
            BattleControl:get():pushEnemyInfomation(this.messages.mess3,0,178,255,7);
            return 1;
        end
    }
