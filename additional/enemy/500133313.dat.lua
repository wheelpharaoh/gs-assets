    ...
    local instance = {
        ...
        takeBreake = function (this,unit)
            if this.isRage then
                ...
                local buff_ =  unit:getTeamUnitCondition():findConditionWithID(-11);
        ...
        update = function (this , unit , deltatime)
            ...
            if this.isRage then
                ...
                if condValue == 0 then
                    ...
                    local buff_ =  unit:getTeamUnitCondition():findConditionWithID(-11);
                    if buff_ == nil then
                        unit:getTeamUnitCondition():addCondition(-11,25,0,2000,9);
                    end
                    unit:setBreakPoint(unit:getBreakPoint() + this.rageHealBreakValue);
        ...
        excuteAction = function (this , unit)
            ...
            if hpparcent < this.consts.rageHP and not this.isRage and this.rageCoolTurnCount > this.consts.rageCoolTurn then
                ...
                unit:getTeamUnitCondition():addCondition(-11,25,0,2000,9);
                unit:getTeamUnitCondition():addCondition(-12,24,0,2000,31);

                local maxBreakPoint = unit:getBaseBreakCapacity();
                local healBreakPoint = maxBreakPoint / 2;
