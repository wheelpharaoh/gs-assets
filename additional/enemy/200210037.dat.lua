...
function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(200210037),
        talk = {
            {text = summoner.Text:fetchByEnemyID(200210037).talk1,color = {r = 220,g = 255,b = 0},isPlayer = true},
            {text = summoner.Text:fetchByEnemyID(200210037).talk2,color = {r = 50,g = 255,b = 0},isPlayer = false},
            {text = summoner.Text:fetchByEnemyID(200210037).talk3,color = {r = 220,g = 255,b = 0},isPlayer = true}
        },
        ...
        setRuState = function (this,state)
            ...
            elseif state == this.ruState.cast then
                ...
                this.ru.orbit:showPopText(this.messages.mess15,"ActionInfo",1,0,1,0,50);
        ...
        getRage = function (this,unit)
            unit:getTeamUnitCondition():addCondition(500382,17,50,9999,26,17);
