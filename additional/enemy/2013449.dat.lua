...
local class = summoner.Bootstrap.createEnemyClass({label="ロゼッタ", version=1.3, id=2013449});
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "お手並み拝見...っと！",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP70_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP70_MESSAGE1 or "マギア・ドライブ",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false        
      },
      [2] = {
         MESSAGE = self.TEXT.HP70_MESSAGE2 or "奥義ゲージ回復速度アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP30_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP30_MESSAGE1 or "本気でいくよー！",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false
      },
      [2] = {
         MESSAGE = self.TEXT.HP30_MESSAGE2 or "行動速度アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false
      }
