...
local class = summoner.Bootstrap.createEnemyClass({label="剣ベリック", version=1.3, id=2013149});
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "魔法ダメージ耐性",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      },
      ...
      [3] = {
         MESSAGE = self.TEXT.START_MESSAGE3 or "樹属性キラー・命中率アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP60_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP60_MESSAGE1 or "マギア・ドライブ！",
         COLOR = Color.red,
         DURATION = 5,
         isPlayer = false        
      },
      [2] = {
         MESSAGE = self.TEXT.HP60_MESSAGE2 or "行動速度アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP40_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP40_MESSAGE1 or "なかなかやるじゃないか…",
         COLOR = Color.red,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP20_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP20_MESSAGE1 or "行動速度・ダメージアップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
...
function class:setupSkill3(unit)
   if not self.isAura then
      ...
      unit:setNextAnimationEffectName("skill3_2")
      if self.isFury then
         -- 特殊真奥義
         self.isFury = false
