function new(id)
    ...
    local instance = {
        ...
        epS4 = 60,
        epS5 = 80,
        messages = summoner.Text:fetchByEnemyID(500721935),
        messageAtk = summoner.Text:fetchByEnemyID(500721935).mess1,
        messageDef = summoner.Text:fetchByEnemyID(500721935).mess2,
        messageBreak = summoner.Text:fetchByEnemyID(500721935).mess3,
        messageLastAttack = summoner.Text:fetchByEnemyID(500721935).mess4,
