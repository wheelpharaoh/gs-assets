...
local class = summoner.Bootstrap.createEnemyClass({label="ヴァーミリア", version=1.3, id=2016449});
...
function class:start(event)
    ...
    self.HPFLG_MESSAGES2 = {
        [0] = {
            MESSAGE = self.TEXT.HPFLG_MESSAGE2 or "まだまだこれからです！",
            COLOR = Color.red,
            DURATION = 5
        }
    }
    ...
    self.HPFLG_MESSAGES3 = {
        [0] = {
            MESSAGE = self.TEXT.HPFLG_MESSAGE3 or "奥義ゲージ速度アップ",
            COLOR = Color.red,
            DURATION = 5
        }
    }
