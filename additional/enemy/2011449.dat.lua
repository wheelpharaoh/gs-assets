...
local class = summoner.Bootstrap.createEnemyClass({label="", version=1.3, id=2011449});
...
function class:start(event)
    ...
    self.RAGE_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.RAGE_MESSAGE1 or "私が全てを打ち砕く！",
            COLOR = Color.yellow,
            DURATION = 5
        }
    }
    ...
    self.START_MESSAGES = {
        [0] = {
            MESSAGE = self.TEXT.START_MESSAGE1 or "全力で行くわよ！",
            COLOR = Color.yellow,
            DURATION = 5
        }
    }
