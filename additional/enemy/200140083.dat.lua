function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(200140083),
        ...
        showStartBuff = function(this)
            this.showMessage(this.messages.mess16,this.colors.yellow,5,26,true);
        ...
        checkHPTrigger = function (this,unit)
            if this.buffTimer < 5 or this.isTalk ~= true then
                return;
            end
        ...
        glabControll = function(this,unit,deltatime)
            ...
            if this.glabTarget ~= nil then
                if this.glabTarget:getTeamUnitCondition():findConditionWithID(500151) == nil then
                    this.glabTarget:getTeamUnitCondition():addCondition(500151,1,-3500,35,2);
        ...
        startWave = function (this , unit , waveNum)
            this.targetUnits = this.findAllUnitByBaseID(106,true);
            local targetCnt = table.maxn(this.targetUnits);
            if targetCnt > 0 then
                this.setDelayItems(this,this.showStartBuff,3);
                this.showMessage(this.messages.mess15,this.colors.yellow,3,0,true);
        ...
        attackDamageValue = function (this , unit , enemy , value)
            ...
            if stanBuff ~= nil and enemy:getBaseID3() ~= 106 then
