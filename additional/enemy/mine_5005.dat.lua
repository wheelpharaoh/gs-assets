...
local class = summoner.Bootstrap.createEnemyClass({label="被験体β－３", version=1.3, id="mine_50005"});
...
function class:start(event)
    ...
    self.START_MESSAGES = {
        {
            MESSAGE = self.TEXT.START_MESSAGE1 or "光・闇属性キラー",
            COLOR = Color.magenta,
            DURATION = 5
        },
        {
            MESSAGE = self.TEXT.START_MESSAGE2 or "炎・水・樹属性耐性",
            COLOR = Color.magenta,
            DURATION = 5
        }
    }
