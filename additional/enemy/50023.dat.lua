...
function new(id)
    ...
    local instance = {
        ...
        ct_timer       = 0, 
        messages = summoner.Text:fetchByEnemyID(50023),
        ...
        startWave = function (this , unit , waveNum)
            BattleControl:get():pushEnemyInfomation(this.messages.mess3,255,0,255,3);
            return 1;
        end,
        ...
        chargeskill = function (this , unit)
            ...
            unit:setInvincibleTime(15);
            BattleControl:get():pushEnemyInfomation(this.messages.mess1,255,0,255,3);
            BattleControl:get():pushEnemyInfomation(this.messages.mess2,255,0,255,5);
