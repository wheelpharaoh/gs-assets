...
function new(id)
    ...
    local instance = {
        ...
        startWave = function (this , unit , waveNum)
            BattleControl:get():pushEnemyInfomation(summoner.Text:fetchByEnemyID(200280080).mess1,220,255,0,5);
            return 1;
        end,
        ...
        update = function (this , unit , deltatime)
            ...
            if not this.isRage and hpParcent < 50 and this.ishost and unit.m_breaktime <= 0 then
