...
local class = summoner.Bootstrap.createEnemyClass({label="タマエ", version=1.3, id=2016258});
...
function class:setMessageBoxList()
   ...
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "今宵は良い月が出ておるぞ",
         COLOR = Color:new(255,132,143),
         DURATION = 5,
         isPlayer = false
      }
   }
   ...
   self.HP30_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP30_MESSAGE1 or "褒めてつかわす",
         COLOR = Color:new(255,132,143),
         DURATION = 5,
         isPlayer = false
      }
   ...
   self.DEAD_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.DEAD_MESSAGE1 or "ああ、月だ、月が視える…",
         COLOR = Color:new(255,132,143),
         DURATION = 5,
         isPlayer = false
      }
