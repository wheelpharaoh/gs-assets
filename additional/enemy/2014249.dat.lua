...
local class = summoner.Bootstrap.createEnemyClass({label="シンシア", version=1.3, id=2014249});
...
function class:setMessageBoxList()
   self.START_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.START_MESSAGE1 or "なかなかやるねー",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP70_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP70_MESSAGE1 or "こっからだよ！",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false        
      },
      [2] = {
         MESSAGE = self.TEXT.HP70_MESSAGE2 or "ダメージアップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false        
      }
   ...
   self.HP30_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.HP30_MESSAGE1 or "ぜんりょくぜんかーい！",
         COLOR = Color.cyan,
         DURATION = 5,
         isPlayer = false
      },
      [2] = {
         MESSAGE = self.TEXT.HP30_MESSAGE2 or "奥義ゲージ速度アップ",
         COLOR = Color.yellow,
         DURATION = 5,
         isPlayer = false
      }
