function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByEnemyID(200040028),
        ...
        setTalkTable = function (this)
            this.chats[1].chat = {
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk1},
                {character = "Roy",talk = summoner.Text:fetchByEnemyID(200040028).talk2},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk3}
            };

            this.chats[2].chat = {
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk4},
                {character = "Roy",talk = summoner.Text:fetchByEnemyID(200040028).talk5},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk6},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk7}
            };

            this.chats[3].chat = {
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk8},
                {character = "Roy",talk = summoner.Text:fetchByEnemyID(200040028).talk9},
                {character = "Grad",talk = summoner.Text:fetchByEnemyID(200040028).talk10}
            };
        end,
        ...
        getRage2 = function (this,unit)
            ...
            this.isRage2 = true;
            unit:setAttackDelay(this.attackTimeDefault);
        end,
        ...
        excuteAction = function (this , unit)
            ...
            if this.utill.getHPParcent(unit) <= 30 and not this.isRage2 and this.utill.isHost() then
                this.getRage2(this,unit);
                this.utill.sendEvent(this,6,1);
            end
