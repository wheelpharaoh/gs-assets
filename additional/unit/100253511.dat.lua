...
function bulletControll(bulletinstance)
    ...
    if bullettarget ~= nil and bulletinstance.yield then
        ...
        print(bulletinstance.limity);


        if math.abs(bulletinstance.limity) >= 30 then
            if bulletinstance.limity  < 0 then
                ydir = bulletinstance.limity - ydir + 30; 
                bulletinstance.limity = bulletinstance.limity + 30;
            else
                ydir = bulletinstance.limity + ydir -30;
                bulletinstance.limity = bulletinstance.limity - 30;
            end;
