function new(id)
    ...
    local instance = {
        ...
        theWorld = function (this,unit)
            for i = 0,7 do
                ...
                if teamUnit ~= nil then
                    teamUnit:playSummary(summoner.Text:fetchByUnitID(101076511).text1,true);
        ...
        receive1 = function (this , intparam)
            this.myself:playSummary(summoner.Text:fetchByUnitID(101076511).text2,true);
        ...
        run = function (this , unit , str)
            ...
            if str == "theWorld2" then return this.theWorld2(this,unit) end
        ...
        takeDamageValue = function (this , unit , enemy , value)
            ...
            if this.isControllTarget(this,unit) then
                if hpParcent <= 40 and this.coolTimer >= this.coolTimeDefalut then
                    this.coolTimer = 0;
                    unit:playSummary(summoner.Text:fetchByUnitID(101076511).text2,true);
