...
local class = summoner.Bootstrap.createUnitClass({label="フェン", version=1.3, id=101054311});
...
-- 各アニメーション
class.BIRD_IN = "1-birdIn"
class.BIRD_IDLE = "1-birdIdle"
class.BIRD_EX = "1-birdEx"
-- 移動速度
class.SPEED = 10
-- 基礎回復量（0~1の割合）
