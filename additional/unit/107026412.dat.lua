function new(id)
    ...
    local instance = {
        ...
        setElementLight = function(this,unit)
            local skill = unit:getActiveBattleSkill();
            if skill ~= nil then
                skill:setElementType(4);
            end
            return 1;
        end,

        setElementDark = function(this,unit)
            local skill = unit:getActiveBattleSkill();
            if skill ~= nil then
                skill:setElementType(5);
            end
            return 1;
        end,
        ...
        run = function (this , unit , str)
            ...
            if str == "setElementLight" then return this.setElementLight(this,unit) end
            if str == "setElementDark" then return this.setElementDark(this,unit) end
            return 1;
        end,
