local class = summoner.Bootstrap.createUnitClass({label="ジェノス", version=1.5, id=107086512});
...
function class:addBuff(unit)
    ...
    if cond ~= nil and cond:getPriority() <= 100 then
        unit:getTeamUnitCondition():removeCondition(cond);
        local newCond = unit:getTeamUnitCondition():addCondition(self.BUFF_ID,29,100,10,34);
        newCond:setGroupID(1022);
        newCond:setPriority(100);
