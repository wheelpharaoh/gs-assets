--@additionalEnemy,100111506,101631506,100233506,100111506,100111506
function new(id)
    print("10000 new ");
    local instance = {
        ...
        nextSummonCounter = 5, --次に雑魚を召喚するまでの行動数
        ...
        summonUnitIDs = {100111506, 101631506, 100233506, 100111506,100111506},
        ...
        summon = function (this,unit)
            ...
            for i = 0 , i_rand do
                local gaul = unit:getTeam():addUnit(this.summonedNumber,this.summonUnitIDs[currentIndex]);--指定したインデックスの位置に指定したエネミーIDのユニットを出す
        ...
        showMessage = function(this)
            -- BattleControl:get():pushEnemyInfomation(summoner.Text:fetchByUnitID(501361513).mess1,255,255,255,3);
        end,
        ...
        receive1 = function (this , intparam)--手の攻撃タイミングと攻撃の種類を同期する
            ...
            local skillOrbit = this.unit:addOrbitSystemWithFile("50136HandEF",efAnimationName);
        ...
        receive4 = function (this , intparam)--タイムオーバー攻撃の同期をする
            ...
            local ef = this.unit:addOrbitSystemWithFile("50136HandEF","skill2");
            ...
            this.meteor = this.unit:addOrbitSystemWithFile("50136HandEF","meteor");
            ...
            this.gameUnit:addOrbitSystemCameraWithFile("50136HandEF","rockAndFlush",false);
            return 1;
        end,
        ...
        deadend = function (this , unit)--プレイヤー全滅
            ...
            for i = 0 , megast.Battle:getInstance():getEnemyTeam():getIndexMax() do
                local teamunit = megast.Battle:getInstance():getEnemyTeam():getTeamUnit(i);
                if teamunit ~= nil then
                if teamunit:getUnitID() ~= 501361513 then 
                    teamunit:setHP(0);
                end
                end
            end
        ...
        startWave = function (this , unit , waveNum)--この中で手とか生成してます
            ...
            this.Gates.back = unit:addOrbitSystemWithFile("50136back_gate","idle");
            ...
            this.Gates.front = unit:addOrbitSystemWithFile("50136HandEF","idle");
            ...
            this.hand = unit:addOrbitSystemWithFile("50136hand","idle");
        ...
        update = function (this , unit , deltatime)
            ...
            unit:setPositionY(this.startY);
             ...
             if this.isIdle and this.handRank > 4 and ishost then
                this.hand:takeAnimation(0,"skill2",true);
                this.hand:setActiveSkill(7);
                this.hand:showSkillName(7);
                local ef = unit:addOrbitSystemWithFile("50136HandEF","skill2");
                ef:setEndAnimationName("none");
                ef:setPositionX(this.hand:getPositionX());
                ef:setPositionY(this.hand:getPositionY());
                ef:getSkeleton():setScale(this.consts.scaleOffset);
                
                this.meteor = unit:addOrbitSystemWithFile("50136HandEF","meteor");
                this.meteor:setPositionX(0);
                this.meteor:setPositionY(0);
                this.meteor:setActiveSkill(7);
                this.meteor:getSkeleton():setScale(this.consts.scaleOffset);
                ...
                unit:addOrbitSystemCameraWithFile("50136HandEF","rockAndFlush",false);
        ...
        excuteAction = function (this , unit)
            ...
            if ishost then
                if this.actionCounter == this.nextSummonCounter then
                    ...
                    rand = math.random(4);
                    this.nextSummonCounter = this.nextSummonCounter + rand ;--次の召喚までの行動数を決める　ある程度ランダムにしたいらしいということで0 ~ 4の乱数を足す
                end
            end
            return 1;
        end,
        ...
        takeSkill = function (this,unit,index)            
            ...
            if ishost then
                ...
                local skillOrbit = unit:addOrbitSystemWithFile("50136HandEF",efAnimationName);
                skillOrbit:setPositionX(this.hand:getPositionX());
                skillOrbit:setPositionY(this.hand:getPositionY());
                this.hand:setActiveSkill(activeSkillNum);
                this.hand:showSkillName(activeSkillNum);
