...
local class = summoner.Bootstrap.createUnitClass({label="シュリ", version=1.8, id=102856512});
...
function class:setSurfaceBoxList()
   ...
   self.SURFACE_BOX_LIST = {
      ...
      [self.afterMD] = {
         ...
         SKILL_NAME = self.TEXT.AFTER_MD or "餓凰凶撃「鳳翔烈破」",
...
function class:run(event)
   ...
   if event.spineEvent == "md6Start" then
      ...
      if self:findWeapon(self.gameUnit,50225200) then
