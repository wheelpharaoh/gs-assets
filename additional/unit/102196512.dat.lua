...
function new(id)
    ...
    local instance = {
        ...
        rainFall = function(this,unit)
            unit:setDamageRateOffset(0.7);
            unit:setBreakRateOffset(0.7);
            local orbit = unit:addOrbitSystem("arrow_rain",0);
            orbit:setDamageRateOffset(0.3);
            orbit:setBreakRateOffset(0.3);
            return 1;
        end,
        ...
        run = function (this , unit , str)
            ...
            if str == "rainFall" then return this.rainFall(this,unit) end            
        ...
        startWave = function (this , unit , waveNum)
            if not this.startDash then
                this.startDash = true;
                local buff = unit:getTeamUnitCondition():findConditionWithID(50234400);
                if buff ~= nil then
                    unit:addSP(100);
                end
            end
