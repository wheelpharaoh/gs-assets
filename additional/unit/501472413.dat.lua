...
local class = summoner.Bootstrap.createUnitClass({label="カボチャラッキー", version=1.3, id=501472413});


class.UNIT_ID = 501472413;
class.HP_RATE = 0.008;
class.POINT = 777777;
...
function class:start(event)
	...
	self.TEXT.DEAD_MESSAGE1 = self.TEXT.DEAD_MESSAGE1 or "ラッキーパンプキンを撃破して+%dpt";
...
function class:dead(event)
	...
	summoner.Utility.messageByEnemy(message,5,Color:new(239,174,0));
