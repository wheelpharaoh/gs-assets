...
-- Funnelクラスを定義
    ...
    instance.Funnel.new = function (funnelUnit, ownerUnit)
        ...
        instance.addOrbit = function (this, str)
            ...
            --通常攻撃ならスキルをリセット
            if str == "lion2attack1" then
                orbit:setActiveSkill(10);
            end
            --skill1なら威力配分
            if str == "lion2skill1" then
    ...
    instance.orbitSystemFileName = "100434312_lion"
    ...
    instance.createFunnel = function (this, unit, animationIndex)
        ...
        local funnelUnit = unit:addOrbitSystemWithFile(this.orbitSystemFileName, "idle")
