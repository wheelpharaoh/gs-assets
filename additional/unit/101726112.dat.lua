    ...
    function cls:addCriticalBuff()
        for i = 0,7 do
            ...
            if teamUnit ~= nil then
                ...
                elseif buffValue >= 50 then
                    teamUnit:playSummary((summoner.Text:fetchByUnitID(101725112).text2):format(60).."％",true);

                    buff = teamUnit:getTeamUnitCondition():addCondition(self.CRITICAL_BUFF_ID,self.CRITICAL_BUFF_EFFECT_ID,60,self.CRITICAL_BUFF_DURATION,self.CRITICAL_BUFF_ICON);
                    buff:setScriptID(37);
                    buff:setNumber(10);
                else
