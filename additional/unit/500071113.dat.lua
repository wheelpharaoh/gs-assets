function new(id)
    ...
    local instance = {
        ...
        Class = 
        {
            ...
            messages = summoner.Text:fetchByUnitID(500071113),
            ...
            drawingAuraEffect = function (this,unit,isDrawing)
                ...
                if isDrawing == true then
                    if this.Class.WindAura == nil then
                        ...
                        BattleControl:get():pushEnemyInfomationWithConditionIcon(this.Class.messages.messageWind1,16,this.Class.windMessagesRGB.r,this.Class.windMessagesRGB.g,this.Class.windMessagesRGB.b,7);
            ...
            startBurn = function (this,unit)
                BattleControl:get():pushEnemyInfomationWithConditionIcon(this.Class.messages.burn,35,this.Class.windMessagesRGB.r,this.Class.windMessagesRGB.g,this.Class.windMessagesRGB.b,7);
                BattleControl:get():pushEnemyInfomationWithConditionIcon(this.Class.messages.burn2,26,255,0,0,7);
            end,

            endBurn = function (this,unit)
                -- BattleControl:get():pushEnemyInfomation(this.Class.messages.burnEnd,255,255,255,5);
            end,
        ...
        startWave = function (this , unit , waveNum)
            BattleControl:get():pushEnemyInfomationWithConditionIcon(this.Class.messages.critical,13,255,0,0,7);
            return 1;
        end,
