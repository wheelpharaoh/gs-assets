...
local class = summoner.Bootstrap.createUnitClass({label="501301313", version=1.3, id=501301313});
...
function class:initMessages()
   ...
   self.TIMEUP_BUFF_MESSAGE_LIST = {
      [1] = {
         MESSAGE = self.TEXT.TIMEUP_BUFF_MESSAGE1 or "タイムアップ",
         COLOR = Color.red,
         DURATION = 5,
         isPlayer = false         
      },
      [2] = {
         MESSAGE = self.TEXT.TIMEUP_BUFF_MESSAGE2 or "っす",
         COLOR = Color.red,
         DURATION = 5,
         isPlayer = false         
      }
