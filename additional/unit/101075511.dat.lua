function new(id)
    ...
    local instance = {
        ...
        theWorld = function (this,unit)
            for i = 0,7 do
                ...
                if teamUnit ~= nil then
                    teamUnit:playSummary(summoner.Text:fetchByUnitID(101075511).text1,true);
        ...
        receive1 = function (this , intparam)
            this.myself:playSummary(summoner.Text:fetchByUnitID(101075511).text2,true);
        ...
        takeDamageValue = function (this , unit , enemy , value)
            ...
            if this.isControllTarget(this,unit) then
                if hpParcent <= 40 and this.coolTimer >= this.coolTimeDefalut then
                    this.coolTimer = 0;
                    unit:playSummary(summoner.Text:fetchByUnitID(101075511).text2,true);
