function new(id)
    ...
    local instance = {
        ...
        changeTurn = 2,--変形までに必要なターン
        changeTurnRandomRange = 3,--変形までに必要なターンの揺らぎ
        firstBreak = 40000,--最初の破壊までに必要なブレイク倍率
        secondBreak = 90000,--次の破壊までに必要なブレイク倍率
        ...
        epS4 = 60,
        epS5 = 80,
        messages = summoner.Text:fetchByUnitID(500721013),
        messageAtk = summoner.Text:fetchByUnitID(500721013).mess1,
        messageDef = summoner.Text:fetchByUnitID(500721013).mess2,
        messageBreak = summoner.Text:fetchByUnitID(500721013).mess3,
        messageLastAttack = summoner.Text:fetchByUnitID(500721013).mess4,
        ...
        ball = function(this,unit)
            ...
            local tama = this.ballinfo.new(shot,targetIndex,0);
        ...
        takeSkill = function (this,unit,index)
            local target = unit:getTargetUnit();
            if target ~= nil then
                this.beforeTargetUnit = target:getIndex();
            end
            local ishost = megast.Battle:getInstance():isHost();
            if ishost then
