function new(id)
    ...
    local instance = {
        ...
        run = function (this , unit , str)
            ...
            if str == "callAttack" then return this.callAttack(this,unit) end
            return 1;
        end,
        ...
        startWave = function (this , unit , waveNum)
            unit:setRange_Min(-10000);
            unit:setRange_Max(10000);
            return 1;
        end,
        ...
        takeIdle = function (this , unit)
            ...
            if megast.Battle:getInstance():getBattleState() == kBattleState_active and unit:getTargetUnit() ~= nil then
