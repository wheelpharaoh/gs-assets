...
local class = summoner.Bootstrap.createUnitClass({label="シキ", version=1.8, id=102846412});

class.MARKING_BUFF_ID = 10284600;--シキのスキル攻撃がヒットした相手であることを示すバフのID マスターから設定 なので後で変える
