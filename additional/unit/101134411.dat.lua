        ...
        Class = 
        {
            ...
            CoupDeGrace = function(this,unit)
                ...
                if this.Class.curSkillType == this.Class.SkillAttackTypes.Attack then
                    ...
                    if targetUnit ~= nil then
                        local attack1 = unit:addOrbitSystemInsightRotation("1-skill2-attack-1","emp",999,(targetUnit:getAnimationPositionX() + 370 * unit:getFlip()) - unit:getPositionX(),(targetUnit:getAnimationPositionY() + 75) - unit:getPositionY(),180,-10);
                        attack1:setDamageRateOffset(1/3);
                        attack1:setBreakRateOffset(1/3);
                        attack1:setSPRateOffset(1/3);
                        attack1:setRotation(attack1:getRotation() + 3);
    
                        local attack2 = unit:addOrbitSystemInsightRotation("1-skill2-attack-2","emp",999,(targetUnit:getAnimationPositionX() + 270 * unit:getFlip()) - unit:getPositionX(),(targetUnit:getAnimationPositionY() + 300) - unit:getPositionY(),180,10);
                        ...
                        local attack3 = unit:addOrbitSystemInsightRotation("1-skill2-attack-3","emp",999,(targetUnit:getAnimationPositionX() + 455 * unit:getFlip())- unit:getPositionX(),(targetUnit:getAnimationPositionY() + 240)- unit:getPositionY(),180,30);
                        ...
                        local attack1 = unit:addOrbitSystemInsightRotation("1-skill2-attack-1","emp",999,100,350,180,0);
                        attack1:setDamageRateOffset(1/3);
                        attack1:setBreakRateOffset(1/3);
                        attack1:setSPRateOffset(1/3);
    
                        local attack2 = unit:addOrbitSystemInsightRotation("1-skill2-attack-2","emp",999,200,250,180,0);
                        attack2:setDamageRateOffset(1/3);
                        attack2:setBreakRateOffset(1/3);
                        attack2:setSPRateOffset(1/3);
    
                        local attack3 = unit:addOrbitSystemInsightRotation("1-skill2-attack-3","emp",999,300,350,180,0);
                        attack3:setDamageRateOffset(1/3);
                        attack3:setBreakRateOffset(1/3);
                        attack3:setSPRateOffset(1/3);
                    end
                ...
                elseif this.Class.curSkillType == this.Class.SkillAttackTypes.Heal then
                    ...
                    unit:addOrbitSystem("1-skill2-heal-1",1);
                    unit:addOrbitSystem("1-skill2-heal-2",1);
                    unit:addOrbitSystem("1-skill2-heal-3",1);
            ...
            playAttackEffect = function(this,unit,attackType)
                ...
                if attackType == this.Class.SkillAttackTypes.Attack then
                    ...
                    if targetUnit ~= nil then
                        unit:addOrbitSystemInsightRotation("1-skill1-attack","emp",999,(targetUnit:getAnimationPositionX() + 270 * unit:getFlip()) - unit:getPositionX(),(targetUnit:getAnimationPositionY() + 200) - unit:getPositionY(),180,0);
                    else
                        unit:addOrbitSystemInsightRotation("1-skill1-attack","emp",999,200,250,180,0);
                    end

                elseif attackType == this.Class.SkillAttackTypes.Heal then
                    unit:addOrbitSystem("1-skill1-heal",1);
                end
                return 1;
            end,
