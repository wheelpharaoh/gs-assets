    ...
    local instance = {
        ...
        Class = 
        {
            ...
            runScriptUpdate = function(this , unit , str)
                if str == "attackShot" then return this.Class.attackShot(this,unit) end
                return 1;
            end,
            ...
            attackShot = function(this,unit)
            
                local attack1 = unit:addOrbitSystemInsightRotation("1--AttackShot","emp",1,-50,100,180,0);
