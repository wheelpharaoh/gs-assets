...
function new(id)
    ...
    function cls:addDodgeBuff(unitIndex)
        ...
        if targetUnit ~= nil then
            ...
            targetUnit:playSummary(summoner.Text:fetchByUnitID(101724112).text1,true);
        end
        return 1;
    end
        ...
        for i = 0,7 do
            ...
            if teamUnit ~= nil then
                ...
                if buffValue >= 60 then
                    teamUnit:playSummary((summoner.Text:fetchByUnitID(101724112).text2):format(buffValue).."％",true);
    ...
    function cls:skillRecast(unit)
        ...
        unit:playSummary(summoner.Text:fetchByUnitID(101724112).text3,true);
