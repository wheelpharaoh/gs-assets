function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByUnitID(500941513);
        ...
        moveToInPosition = function(this,unit)
            unit:setPosition(120,-50);
            return 1;
        end,
        ...
        run = function (this , unit , str)
            ...
            if str == "moveToInPosition" then return this.moveToInPosition(this,unit) end
            return 1;
        end,
