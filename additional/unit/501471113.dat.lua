...
local class = summoner.Bootstrap.createUnitClass({label="カボチャ炎", version=1.3, id=501471113});


class.UNIT_ID = 501471113;
class.HP_RATE = 0.002;
class.POINT = 200000;
...
function class:start(event)
	...
	self.TEXT.DEAD_MESSAGE1 = self.TEXT.DEAD_MESSAGE1 or "レッドパンプキンを撃破して+%dpt";
...
function class:dead(event)
	...
	summoner.Utility.messageByEnemy(message,5,Color.red);
