        ...
        attackDamageValue = function (this , unit , enemy , value)
            ...
            if cond == nil then
                if enemy:getElementType() == 1 then
                    this.utill.addConditionWithPriority(enemy,101165511,62,-30,15,44,this.groupID,30);
                    
                elseif enemy:getElementType() == 2 then
                    this.utill.addConditionWithPriority(enemy,101165511,63,-30,15,45,this.groupID,30);
                elseif enemy:getElementType() == 3 then
                    this.utill.addConditionWithPriority(enemy,101165511,61,-30,15,43,this.groupID,30);
                elseif enemy:getElementType() == 4 then
                    this.utill.addConditionWithPriority(enemy,101165511,65,-30,15,47,this.groupID,30);
                elseif enemy:getElementType() == 5 then
                    this.utill.addConditionWithPriority(enemy,101165511,64,-30,15,46,this.groupID,30);
                end
            end
