...
local class = summoner.Bootstrap.createUnitClass({label="カボチャ樹", version=1.3, id=501471313});


class.UNIT_ID = 501471313;
class.HP_RATE = 0.002;
class.POINT = 200000;
...
function class:start(event)
	...
	self.TEXT.DEAD_MESSAGE1 = self.TEXT.DEAD_MESSAGE1 or "グリーンパンプキンを撃破して+%dpt";
...
function class:dead(event)
	...
	summoner.Utility.messageByEnemy(message,5,Color.green);
