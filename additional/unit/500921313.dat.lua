function new(id)
    ...
    local instance = {
        ...
        Class = 
        {
            ...
            messages = summoner.Text:fetchByUnitID(500921313),
            ...
            drawingAuraEffect = function (this,unit,isDrawing)
                ...
                if isDrawing == true then
                    if this.Class.WindAura == nil then
                        ...
                        BattleControl:get():pushEnemyInfomationWithConditionIcon(this.Class.messages.messageWind2,35,this.Class.windMessagesRGB.r,this.Class.windMessagesRGB.g,this.Class.windMessagesRGB.b,7);
                        unit:getTeamUnitCondition():addCondition(-12, 7, 3000, 9999, 35);
