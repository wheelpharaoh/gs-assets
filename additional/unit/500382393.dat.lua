...
function new(id)
    ...
    local instance = {
        ...
        messages = summoner.Text:fetchByUnitID(500382393),

        talk = {
            {text = summoner.Text:fetchByUnitID(500382393).talk1,color = {r = 220,g = 255,b = 0},isPlayer = true},
            {text = summoner.Text:fetchByUnitID(500382393).talk2,color = {r = 50,g = 255,b = 0},isPlayer = false},
            {text = summoner.Text:fetchByUnitID(500382393).talk3,color = {r = 220,g = 255,b = 0},isPlayer = true}
        },
