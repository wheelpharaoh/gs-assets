function new(id)
    ...
    instance.orbitNames = { grave = "1grave", spear = "1spear", collision = "collision" }
    -- 敵座標キャッシュ用テーブル
    ...
    instance.addOrbit = function (this, unit, orbitName)
        ...
        if orbitName == this.orbitNames.grave then
            addObj = unit:addOrbitSystem(this.orbitNames.grave, 0)
            setZOrder = -1
        elseif orbitName == this.orbitNames.spear then
            addObj = unit:addOrbitSystem(this.orbitNames.spear, 0)
            setZOrder = 1
        elseif orbitName == this.orbitNames.collision then
            addObj = unit:addOrbitSystem(this.orbitNames.collision, 0)
        end
    ...
    instance.run = function (this , unit , str)
        ...
        local arg = string.match(str, "addOrbit(%w+)")
