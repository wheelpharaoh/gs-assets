function new(id)
    ...
    local instance = {
        ...
        executeBloodlineTrait = function(this,unit)
            ...
            unit:playSummary(summoner.Text:fetchByUnitID(101785512).text2..this.buffLevel , true);
        end,
        ...
        attackDamageValue = function (this , unit , enemy , value)
            ...
            if skillType == 2 and enemy == boss then
                ...
                unit:playSummary(summoner.Text:fetchByUnitID(101785512).text1 , true);
                enemy:playSummary(summoner.Text:fetchByUnitID(101785512).text1 , true);
            end
