    ...
    local instance = {
        ...
        run = function (this , unit , str)
            if str == "hpDecriment" then 
                ...
                this.decrimentSpeed = unit:getCalcHPMAX()/5;
            end
            if str == "hpDecriment2" then 
                this.hpDecriment = true;
                this.decrimentTargetHP = unit:getCalcHPMAX()*0.3;
                this.decrimentSpeed = unit:getCalcHPMAX()*0.3;
            end
            return 1;
        end,
        ...
        update = function (this , unit , deltatime)
            if this.hpDecriment then
                if this.decrimentTimer < 1 and this.decrimentTargetHP > 0 then
                    ...
                    local tmp =  this.decrimentSpeed * deltatime;
