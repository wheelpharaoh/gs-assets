--@additionalEnemy,1001404,1001405,1001406
--[[
    クエストに紐づくスクリプト
    ゴルネコ強襲 初級
    ルール
...
function quest_init()
    ...
    Quest = {
        ...
        ENEMY_ID_LIST = {1001404, 1001405, 1001406},
        -- int エネミーの上限
        ...
        MAX_ENEMY_INDEX = 7,
        -- string 撃破数表示の文言
        DEAD_ENEMY_TEXT = summoner.Text:fetchByQuestID(1001402).DEAD_ENEMY_TEXT,
        -- Quest 自分のインスタンス
        _instance = nil
    }
    ...
    function Quest:new()
        ...
        local vars = {
            ...
            summonEnemyIdList = self.ENEMY_ID_LIST,
            -- int 討伐したエネミーの数
            numDeadEnemies = 0,
            -- int 召喚したエネミーの数
