...
if not LWF.Script.collecting_b then LWF.Script.collecting_b={} end

LWF.Script.collecting_b._root_115_2 = function(self)
...
LWF.Script.collecting_b._root_12_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_b._root_73_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_b.chara_move_25_1 = function(self)
	local _root = self.lwf._root

	playSound("SE_SYSTEM_048_COLLECTING_B")
end

LWF.Script.collecting_b.eff3_0_1 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_b.eff5_0_1 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_b.eff7_0_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_b.movie1_0_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_b.movie1_59_2 = function(self)
	local _root = self.lwf._root

	self:gotoAndPlay("loop_"..ptrn)
end

LWF.Script.collecting_b.txt_1_0_1 = function(self)
	local _root = self.lwf._root
