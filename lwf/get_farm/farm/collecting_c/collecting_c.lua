...
if not LWF.Script.collecting_c then LWF.Script.collecting_c={} end

LWF.Script.collecting_c._root_115_2 = function(self)
...
LWF.Script.collecting_c._root_12_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_c._root_73_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_c.chara_move_25_1 = function(self)
	local _root = self.lwf._root

	playSound("SE_SYSTEM_049_COLLECTING_C")
end

LWF.Script.collecting_c.eff3_0_1 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_c.eff5_0_1 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_c.eff7_0_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_c.movie1_0_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.collecting_c.movie1_59_2 = function(self)
	local _root = self.lwf._root

	self:gotoAndPlay("loop_"..ptrn)
end

LWF.Script.collecting_c.txt_1_0_1 = function(self)
	local _root = self.lwf._root
