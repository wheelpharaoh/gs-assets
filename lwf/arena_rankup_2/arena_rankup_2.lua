...
LWF.Script.arena_rankup_2.arena_rankup_body_all_56_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.arena_rankup_body_all_57_2 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_134_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_210_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_312_3 = function(self)
	local _root = self.lwf._root

	playSound("SE_SYSTEM_074_QUEST_MISSION_COMP")
end

LWF.Script.arena_rankup_2.ord_and_board_33_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_387_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_493_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_574_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_683_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_753_3 = function(self)
	local _root = self.lwf._root
...
LWF.Script.arena_rankup_2.ord_and_board_865_3 = function(self)
	local _root = self.lwf._root
